...
function Projects(){
    return(
        <div>
          <div className="bg-white flex flex-col space-y-10 rounded-3xl mt-28  mx-2  md:mx-28 sm:mx-18 p-4  dark:dark:bg-slate-800 dark:text-white  dark:border-white dark:border dark:border-solid  text-md text-gray-700 font-medium ">
                  ...
                  <p className="text-gray-700 text-md ">Explore some of my exciting projects. Most projects are open source, and I welcome your inquiries for more details or collaboration opportunities.</p>
