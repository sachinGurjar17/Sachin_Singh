...
function About(){
    return (
        <>
            <div className=" bg-white flex flex-col  space-y-10 rounded-3xl mt-28  flex-wrap  mx-6  md:mx-28 sm:mx-18  pb-6  dark:dark:bg-slate-800 dark:text-white  dark:border-white dark:border dark:border-solid  text-md text-gray-700 font-medium p-4 shadow-2xl">
