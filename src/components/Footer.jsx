...
function Footer(){
  return(
    <>
              ...
              <div class="flex items-center gap-4">
                <div class="social-button">
                  <button class="relative w-12 h-12 rounded-full group">
                    ...
                    >
                      <a href="https://www.instagram.com/sachin_sg17/" target="_blank">                      <svg
                ...
                <div class="social-button">
                  <button class="relative w-12 h-12 rounded-full group">
                    ...
                    >
                      <a href="https://github.com/sachinGurjar17" target="_blank">                      <svg
                        height="24"
                        width="24"
                        viewBox="0 0 24 24"
                        xmlns="http://www.w3.org/2000/svg"
                ...
                <div class="social-button">
                  <button class="relative w-12 h-12 rounded-full group">
                    ...
                    <div
                      class="icon relative z-10 w-full h-full flex items-center justify-center border-2 border-black rounded-full"
                    >
                      <a href="https://x.com/sachin_sg17" target="_blank">                      <svg
                        fill="none"
                        viewBox="0 0 22 22"
                        height="22"
                        width="22"
                ...
                <div class="social-button">
                  <button class="relative w-12 h-12 rounded-full group">
                    ...
                    >
                      <a href="https://www.linkedin.com/in/sachinsg17/" target="_blank">
                        <svg
                          height="24"
                          width="24"
                          viewBox="0 0 24 24"
      ...
      <div className=' bg-slate-100 m-4 sm:m-6 rounded-3xl sm:p-8 p-4  dark:dark:bg-zinc-900 dark:text-white border  dark:border-gray-600 '>
          <a href='https://www.linkedin.com/in/sachinsg17/' rel="noopener noreferrer"  target="_blank" className='flex justify-center items-center text-md sm:text-lg font-semibold text-slate-500 p-4 '>Share your feedback/suggestions about this website on LinkedIn<GoArrowUpRight/></a>
      </div>
    </>
  )
}
